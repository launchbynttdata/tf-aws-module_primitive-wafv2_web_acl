...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_wafv2_web_acl_regional"></a> [wafv2\_web\_acl\_regional](#module\_wafv2\_web\_acl\_regional) | terraform.registry.launch.nttdata.com/module_primitive/wafv2_web_acl_regional/aws | ~> 1.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_resource_names_map"></a> [resource\_names\_map](#input\_resource\_names\_map) | A map of key to resource\_name that will be used by tf-launch-module\_library-resource\_name to generate resource names | <pre>map(object({<br>    name       = string<br>    max_length = optional(number, 60)<br>    region     = optional(string, "eastus2")<br>  }))</pre> | <pre>{<br>  "web_acl": {<br>    "max_length": 80,<br>    "name": "acl",<br>    "region": "us-east-2"<br>  }<br>}</pre> | no |
