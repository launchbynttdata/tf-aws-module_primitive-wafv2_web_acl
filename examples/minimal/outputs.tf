...
output "wafv2_web_acl_id" {
  ...
  value       = module.wafv2_web_acl_regional.wafv2_web_acl_id
}
...
output "wafv2_web_acl_scope" {
  ...
  value       = module.wafv2_web_acl_regional.wafv2_web_acl_scope
}

output "wafv2_web_acl_capacity" {
  description = "Web ACL capacity units (WCUs) currently being used by this web ACL."
  value       = module.wafv2_web_acl_regional.wafv2_web_acl_capacity
}
