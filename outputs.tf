...
output "wafv2_web_acl_id" {
  ...
  value       = aws_wafv2_web_acl.wafv2_web_acl_regional.id
}

output "wafv2_web_acl_arn" {
  description = "The ARN of the WAF WebACL."
  value       = aws_wafv2_web_acl.wafv2_web_acl_regional.arn
}
...
output "wafv2_web_acl_application_integration_url" {
  ...
  value       = aws_wafv2_web_acl.wafv2_web_acl_regional.application_integration_url
}

output "wafv2_web_acl_capacity" {
  description = "Web ACL capacity units (WCUs) currently being used by this web ACL."
  value       = aws_wafv2_web_acl.wafv2_web_acl_regional.capacity
}
